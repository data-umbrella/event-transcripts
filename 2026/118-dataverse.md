# Dataverse: an Open-Source Platform for Research Data
...
## Key Links
- video: https://youtu.be/AUboDTH_qSo
...
- The FAIR principles: https://doi.org/10.1038/sdata.2016.18
- "Intro to Zenodo" event. The video is here: https://youtu.be/eChOfh8t04k
- https://github.com/gdcc/pyDataverse
- It Takes a Village Framework: https://itav.lyrasis.org/
- Scroll to the bottom of our project home page to find the map of current Dataverse installations around the world. Perhaps your country is represented here! https://dataverse.org/
- CAFE Project: https://www.climatehealthcafe.org/
- Dataverse TV is where we share recordings: https://dataverse.org/dataversetv. Many great talks from Dataverse Community members.
- GREI - Generalist Repository Ecosystem Initiative (NIH): https://datascience.nih.gov/data-ecosystem/generalist-repository-ecosystem-initiative
- Integrations across the research data lifecycle: https://guides.dataverse.org/en/latest/admin/integrations.html
- Building external tools for Dataverse software: https://guides.dataverse.org/en/latest/api/external-tools.html
- There is a question about repositories for genetic and metabolic data. The National Institutes for Health (NIH) site has an excellent resource for finding NIH domain-specific repositories: https://grants.nih.gov/policy-and-compliance/policy-topics/sharing-policies/accessing-data/scientific
- For Europe: https://elixir-europe.org/platforms/data/core-data-resources
- Here is one group that uses Harvard Dataverse Repository for their genome data and an interview I conducted with their team. It still supports their managed data workflow: https://zenodo.org/records/17081413
- CAFE, RCC group on Harvard Dataverse Repository: https://zenodo.org/records/18489235
- 2026 Dataverse community meeting is in Barcelona: https://dcm2026.com/
...
## Video 
<a href="http://www.youtube.com/watch?feature=player_embedded&v=AUboDTH_qSo" target="_blank"><img src="http://img.youtube.com/vi/AUboDTH_qSo/0.jpg" alt="Dataverse" width="50%" /></a>
